defmodule PhotoFinishWeb.Components.ScrollArea do
  @moduledoc """
  The `PhotoFinishWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
