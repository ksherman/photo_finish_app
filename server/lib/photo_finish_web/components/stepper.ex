defmodule PhotoFinishWeb.Components.Stepper do
  @moduledoc """
  The `PhotoFinishWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `PhotoFinishWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
