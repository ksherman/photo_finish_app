defmodule PhotoFinishWeb.Components.NativeSelect do
  @moduledoc """
  The `PhotoFinishWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `PhotoFinishWeb.Components.NativeSelect`
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/forms/native-select
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhotoFinishWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhotoFinishWeb.Gettext, "errors", msg, opts)
    end
  end
end
