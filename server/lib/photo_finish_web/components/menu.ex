defmodule PhotoFinishWeb.Components.Menu do
  @moduledoc """
  The `PhotoFinishWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `PhotoFinishWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/menu
  ...
  import PhotoFinishWeb.Components.Button, only: [button_link: 1]
