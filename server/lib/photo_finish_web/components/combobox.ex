defmodule PhotoFinishWeb.Components.Combobox do
  @moduledoc """
  The `PhotoFinishWeb.Components.Combobox` is a Phoenix LiveView component module for creating customizable combobox elements.
