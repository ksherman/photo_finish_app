defmodule PhotoFinishWeb.Components.Banner do
  @moduledoc """
  PhotoFinishWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
