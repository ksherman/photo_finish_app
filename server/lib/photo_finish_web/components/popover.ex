defmodule PhotoFinishWeb.Components.Popover do
  @moduledoc """
  The `PhotoFinishWeb.Components.Popover` module provides a versatile popover component for Phoenix LiveView
