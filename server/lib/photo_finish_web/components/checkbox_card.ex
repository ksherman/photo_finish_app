defmodule PhotoFinishWeb.Components.CheckboxCard do
  @moduledoc """
  The `PhotoFinishWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
