defmodule PhotoFinishWeb.Components.Chat do
  @moduledoc """
  `PhotoFinishWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
