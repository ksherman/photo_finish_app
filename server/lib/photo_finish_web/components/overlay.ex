defmodule PhotoFinishWeb.Components.Overlay do
  @moduledoc """
  The `PhotoFinishWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `PhotoFinishWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
