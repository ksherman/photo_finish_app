defmodule PhotoFinishWeb.Components.CheckboxField do
  @moduledoc """
  PhotoFinishWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
