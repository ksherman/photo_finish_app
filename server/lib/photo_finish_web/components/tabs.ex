defmodule PhotoFinishWeb.Components.Tabs do
  @moduledoc """
  `PhotoFinishWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tabs
  ...
  import PhotoFinishWeb.Components.Badge, only: [badge: 1]
