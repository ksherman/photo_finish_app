defmodule PhotoFinishWeb.Components.Spinner do
  @moduledoc """
  The `PhotoFinishWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `PhotoFinishWeb.Components.Spinner` module enables developers to provide
