defmodule PhotoFinishWeb.Components.Indicator do
  @moduledoc """
  The `PhotoFinishWeb.Components.Indicator` module provides a versatile component for visually highlighting
