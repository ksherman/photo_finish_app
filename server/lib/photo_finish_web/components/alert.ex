defmodule PhotoFinishWeb.Components.Alert do
  @moduledoc """
  PhotoFinishWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
