defmodule PhotoFinishWeb.Components.MegaMenu do
  @moduledoc """
  The `PhotoFinishWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
