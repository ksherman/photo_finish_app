defmodule PhotoFinishWeb.Components.UrlField do
  @moduledoc """
  PhotoFinishWeb.Components.UrlField, A component for rendering a URL input field in a Phoenix application.
