defmodule PhotoFinishWeb.Components.Clipboard do
  @moduledoc """
  The `PhotoFinishWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
