defmodule PhotoFinishWeb.Components.TableContent do
  @moduledoc """
  `PhotoFinishWeb.Components.TableContent` is a component module designed to create flexible and dynamic
