defmodule PhotoFinishWeb.Components.Image do
  @moduledoc """
  The `PhotoFinishWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
