defmodule PhotoFinishServerWeb.Components.Carousel do
  @moduledoc """
  Provides a versatile and customizable carousel component for the `PhotoFinishServerWeb.Components.Carousel`
  project.
