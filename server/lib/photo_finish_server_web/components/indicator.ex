defmodule PhotoFinishServerWeb.Components.Indicator do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.Indicator` module provides a versatile component for visually highlighting
