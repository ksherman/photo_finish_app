defmodule PhotoFinishServerWeb.Components.Progress do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.Progress` module provides a customizable progress bar component for
