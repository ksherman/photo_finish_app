defmodule PhotoFinishServerWeb.Components.FormWrapper do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.FormWrapper` module provides a flexible and customizable form
