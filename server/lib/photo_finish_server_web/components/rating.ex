defmodule PhotoFinishServerWeb.Components.Rating do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.Rating` module provides a versatile rating component for Phoenix LiveView
