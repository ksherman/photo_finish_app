defmodule PhotoFinishServerWeb.Components.Pagination do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.Pagination` module provides a comprehensive and highly customizable
