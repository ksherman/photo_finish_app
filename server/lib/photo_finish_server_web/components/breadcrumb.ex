defmodule PhotoFinishServerWeb.Components.Breadcrumb do
  @moduledoc """
  Provides a flexible and customizable `PhotoFinishServerWeb.Components.Breadcrumb` component for displaying
