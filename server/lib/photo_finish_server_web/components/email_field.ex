defmodule PhotoFinishServerWeb.Components.EmailField do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.EmailField` module provides a customizable email input field
