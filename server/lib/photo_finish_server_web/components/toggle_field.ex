defmodule PhotoFinishServerWeb.Components.ToggleField do
  @moduledoc """
  PhotoFinishServerWeb.Components.ToggleField component renders a toggle field with customizable options.
