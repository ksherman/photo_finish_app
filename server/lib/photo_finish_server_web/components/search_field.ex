defmodule PhotoFinishServerWeb.Components.SearchField do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.SearchField` module provides a highly customizable search input
