defmodule PhotoFinishServerWeb.Components.Skeleton do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.Skeleton` module provides a reusable component for displaying skeleton
