defmodule PhotoFinishServerWeb.Components.TableContent do
  @moduledoc """
  `PhotoFinishServerWeb.Components.TableContent` is a component module designed to create flexible and dynamic
