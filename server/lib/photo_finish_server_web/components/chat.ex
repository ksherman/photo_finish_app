defmodule PhotoFinishServerWeb.Components.Chat do
  @moduledoc """
  `PhotoFinishServerWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
