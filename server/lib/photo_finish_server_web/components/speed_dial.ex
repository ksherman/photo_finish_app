defmodule PhotoFinishServerWeb.Components.SpeedDial do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.SpeedDial` module provides a versatile speed dial component for Phoenix
