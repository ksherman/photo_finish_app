...
if Ash.read!(ProductTemplate) == [] do
  templates = [
    %{
      product_type: :usb,
      product_name: "All Photos USB Drive",
      default_price_cents: 10_000,
      display_order: 0
    },
    %{
      product_type: :print,
    ...
    %{
      product_type: :print,
      product_name: "11x14 Print",
      product_size: "11x14",
      default_price_cents: 4_000,
      display_order: 3
    },
    %{
      product_type: :print,
      product_name: "16x20 Print",
      product_size: "16x20",
      default_price_cents: 6_500,
      display_order: 4
    }
  ]
