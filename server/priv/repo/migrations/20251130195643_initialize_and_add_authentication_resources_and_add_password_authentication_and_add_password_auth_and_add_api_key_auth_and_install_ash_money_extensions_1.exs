defmodule PhotoFinishServer.Repo.Migrations.InitializeAndAddAuthenticationResourcesAndAddPasswordAuthenticationAndAddPasswordAuthAndAddApiKeyAuthAndInstallAshMoneyExtensions1 do
  @moduledoc """
