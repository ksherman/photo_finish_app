import Config
config :photo_finish, Oban, testing: :manual
config :photo_finish, token_signing_secret: "LrYFRKG3TOLeusQ1r1mLZ/GBYhNTMSpp"
...
config :photo_finish, PhotoFinish.Mailer, adapter: Swoosh.Adapters.Test
