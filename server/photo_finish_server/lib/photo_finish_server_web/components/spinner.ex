defmodule PhotoFinishServerWeb.Components.Spinner do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `PhotoFinishServerWeb.Components.Spinner` module enables developers to provide
