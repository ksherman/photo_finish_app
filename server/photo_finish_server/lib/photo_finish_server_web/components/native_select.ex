defmodule PhotoFinishServerWeb.Components.NativeSelect do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `PhotoFinishServerWeb.Components.NativeSelect`
