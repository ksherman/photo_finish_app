defmodule PhotoFinishServerWeb.Components.Footer do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.Footer` module provides a customizable footer component for Phoenix applications,
