defmodule PhotoFinishServerWeb.Components.Blockquote do
  @moduledoc """
  This module provides a versatile `PhotoFinishServerWeb.Components.Blockquote` component for creating
