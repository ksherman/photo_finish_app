defmodule PhotoFinishServerWeb.Components.MegaMenu do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
