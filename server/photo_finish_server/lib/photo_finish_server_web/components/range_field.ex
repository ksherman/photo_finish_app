defmodule PhotoFinishServerWeb.Components.RangeField do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.RangeField` module provides a comprehensive range input field
