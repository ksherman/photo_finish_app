defmodule PhotoFinishServerWeb.Components.Combobox do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.Combobox` is a Phoenix LiveView component module for creating customizable combobox elements.
