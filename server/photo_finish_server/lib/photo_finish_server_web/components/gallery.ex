defmodule PhotoFinishServerWeb.Components.Gallery do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.Gallery` module provides a customizable gallery component for displaying
