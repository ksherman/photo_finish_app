defmodule PhotoFinishServerWeb.Components.Overlay do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `PhotoFinishServerWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
