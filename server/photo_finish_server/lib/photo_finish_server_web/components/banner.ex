defmodule PhotoFinishServerWeb.Components.Banner do
  @moduledoc """
  PhotoFinishServerWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
