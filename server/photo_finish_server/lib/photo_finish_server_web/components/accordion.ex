defmodule PhotoFinishServerWeb.Components.Accordion do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.Accordion` module provides a flexible and customizable accordion
