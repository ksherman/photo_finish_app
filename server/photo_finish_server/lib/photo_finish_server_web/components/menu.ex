defmodule PhotoFinishServerWeb.Components.Menu do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `PhotoFinishServerWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/menu
  ...
  import PhotoFinishServerWeb.Components.Button, only: [button_link: 1]
