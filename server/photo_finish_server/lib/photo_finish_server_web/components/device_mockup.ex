defmodule PhotoFinishServerWeb.Components.DeviceMockup do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.DeviceMockup` module provides a customizable component for displaying
