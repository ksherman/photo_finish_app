defmodule PhotoFinishServerWeb.Components.Jumbotron do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.Jumbotron` module provides a versatile component for creating large,
