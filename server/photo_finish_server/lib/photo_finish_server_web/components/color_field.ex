defmodule PhotoFinishServerWeb.Components.ColorField do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.ColorField` module provides a reusable and customizable color
