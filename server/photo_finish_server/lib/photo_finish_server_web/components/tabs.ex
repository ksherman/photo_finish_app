defmodule PhotoFinishServerWeb.Components.Tabs do
  @moduledoc """
  `PhotoFinishServerWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tabs
  ...
  import PhotoFinishServerWeb.Components.Badge, only: [badge: 1]
