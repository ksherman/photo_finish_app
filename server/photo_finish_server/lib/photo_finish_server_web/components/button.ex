defmodule PhotoFinishServerWeb.Components.Button do
  @moduledoc """
  Provides a comprehensive set of button components for the `PhotoFinishServerWeb.Components.Button` project.
