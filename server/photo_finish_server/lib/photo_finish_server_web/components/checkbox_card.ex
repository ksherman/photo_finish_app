defmodule PhotoFinishServerWeb.Components.CheckboxCard do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
