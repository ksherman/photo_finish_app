defmodule PhotoFinishServerWeb.Components.Modal do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.Modal` module provides a versatile and customizable modal component for
