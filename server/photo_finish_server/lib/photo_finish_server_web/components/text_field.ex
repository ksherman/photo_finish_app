defmodule PhotoFinishServerWeb.Components.TextField do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.TextField` module provides a highly customizable text input field
