defmodule PhotoFinishServerWeb.Components.Image do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
