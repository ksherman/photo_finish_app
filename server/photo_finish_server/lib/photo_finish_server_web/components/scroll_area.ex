defmodule PhotoFinishServerWeb.Components.ScrollArea do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
