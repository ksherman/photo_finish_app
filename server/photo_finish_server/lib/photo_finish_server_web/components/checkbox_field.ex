defmodule PhotoFinishServerWeb.Components.CheckboxField do
  @moduledoc """
  PhotoFinishServerWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
