defmodule PhotoFinishServerWeb.Components.Table do
  @moduledoc """
  `PhotoFinishServerWeb.Components.Table` is a versatile component for creating customizable tables in a
