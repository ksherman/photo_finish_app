defmodule PhotoFinishServerWeb.Components.Clipboard do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
