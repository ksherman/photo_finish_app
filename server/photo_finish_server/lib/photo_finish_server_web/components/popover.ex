defmodule PhotoFinishServerWeb.Components.Popover do
  @moduledoc """
  The `PhotoFinishServerWeb.Components.Popover` module provides a versatile popover component for Phoenix LiveView
