defmodule PhotoFinishServerWeb.Components.Badge do
  @moduledoc """
  Provides customizable and flexible badge components for use in Phoenix LiveView.

  The `PhotoFinishServerWeb.Components.Badge` module allows you to create badge elements with various styles,
